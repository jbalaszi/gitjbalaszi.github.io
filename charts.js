...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var otu_labels = result.otu_results;
    ...
    var yticks = otu_ids.slice(0, 10).map(otuID => 'OTU ${otu_ID}').reverse();
...
//// Deliverable 2: Bar + Bubble Charts
...
var gaugeData = [{
  ...
  type: "indicator",
  mode: "gauge+number",
  title: {text: "<b> Belly Buttom Washing Frequency</b> # of Scrubs per Week"},
  gauge: {
...
PLoyly.newPlot("gauge", gaugeData, gaugeLayout);
});
